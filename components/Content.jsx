...
const Content = () => {
  const content = [
    ...
    {date: " Mar 23, 2023 ", ket: " 3 min read ", title1: "TikTok CEO", title2: " data security - CBSNEWS", media: "/Tiktok.mp4", link: "https://www.cbsnews.com/video/new-attack-targets-us-base-in-syria-following-american-airstrikes-over-contractors-death/?intcid=CNM-00-10abd1h", desc: "TikTok CEO Shou Zi Chew plans to tell a House committee taking real action."},
